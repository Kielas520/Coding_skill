...
name: dev-assistant
description: >
  全栈开发助手，适用于机器人应用、服务端和客户端开发的完整生命周期。
  当用户需要项目初始化、代码审查、Bug 修复、测试编写、文档生成、
  Git 工作流或任务管理时使用此技能。使用中文交互。
---
...
- **主要语言**：Python（默认），C++（提速模块），未来可能引入 Rust
- **文档语言**：中文
- **Commit 格式**：改 <模块> 的 <内容> 解决了 <问题>
- **文档结构**：详见 `prompts/doc-templates.md`
- **Bug 流程**：详见 `prompts/bug-workflow.md`
